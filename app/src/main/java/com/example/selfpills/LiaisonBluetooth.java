 ...
 * $LastChangedDate: 2021-05-28 14:33:28 +0200 (ven. 28 mai 2021) $
 */
...
public class LiaisonBluetooth extends Thread
{
     ...
     * @param adresseAppareil Adresse de l'appareil auquel se connecter
     * @param handlerIHM Handler vers l'IHM
     */
    public LiaisonBluetooth(String nomAppareil, String adresseAppareil, Handler handlerIHM)
    {
        ...
        else if(rechercherAppareil(adresseAppareil))
        {
            creerSocket();
        }
    }
